...
// recordBrowse("http://localhost:70/airpollution/Q&A.php");  
...
if (isset($_POST['btnsubmit'])) 
{
	...
	$insert= mysqli_query($connection,"INSERT INTO QandA (userID,question,questionDate) VALUES ('$CName','$CAsk','$CDate')");
	if($insert) 
	{
...
$select= mysqli_query($connection,"SELECT * FROM QandA");
